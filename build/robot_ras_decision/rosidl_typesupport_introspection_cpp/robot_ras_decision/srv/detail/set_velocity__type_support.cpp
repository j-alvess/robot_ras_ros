...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetVelocity_Request_message_member_array[1] = {
  {
    ...
    offsetof(robot_ras_decision::srv::SetVelocity_Request, linear_velocity),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetVelocity_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_ras_decision::srv::SetVelocity_Response, sucesso),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
